...
namespace StarWarsGraphQLNetCore.Data.EntityFramework.Seed
{
    public static class StarWarsSeedData
    {
        public static void EnsureSeedData(this StarWarsContext db)
        {
            ...
            var episodes = new List<Episode> { newhope, empire, jedi };
            if (!db.Episodes.Any())
            {
            ...
            var planets = new List<Planet> { tatooine, alderaan };
            if (!db.Planets.Any())
            {
            ...
            var humans = new List<Human> { luke, vader, han, leia, tarkin };
            if (!db.Humans.Any())
            {
            ...
            var droids = new List<Droid> { threepio, artoo };
            if (!db.Droids.Any())
            {
            ...
            var characters = new List<Character> { luke, vader, han, leia, tarkin, threepio, artoo };
